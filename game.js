...
class Police {
  constructor(x,y){ this.x=x;this.y=y;this.w=28;this.h=52;this.vx=-0.85;this.vy=0;this.onGround=false;this.state='walk';this.hitTimer=0;this.deadTimer=0;this.dir=-1;this.startX=x;this.range=130;this.step=0;this.stepT=0; }
  update(){
...
function _drawPolice(x,y,w,h,dir,step,hurt){
  ...
  ctx.fillStyle=navy;
  ctx.fillRect(x+3,   y+h*.62-(step?4:0),10,h*.38+(step?4:0));
  ctx.fillRect(x+w-13,y+h*.62+(step?4:0),10,Math.max(4,h*.38-(step?4:0)));
  ctx.fillStyle='#111';ctx.fillRect(x+1,y+h-7,12,7);ctx.fillRect(x+w-13,y+h-7,12,7);
  ctx.fillStyle=navy;ctx.fillRect(x+2,y+h*.34,w-4,h*.3);
  ctx.fillStyle='#dde';ctx.fillRect(x+w/2-4,y+h*.34,8,7);
  ctx.fillStyle='#f1c40f';ctx.fillRect(x+5,y+h*.4,8,5);
  ctx.fillStyle='#111';ctx.fillRect(x+2,y+h*.61,w-4,4);
  ctx.fillStyle='#333';ctx.fillRect(x+w-11,y+h*.58,8,6);
  ctx.fillStyle=navyL;ctx.fillRect(x-3,y+h*.36,8,20);ctx.fillRect(x+w-5,y+h*.36,8,20);
  ctx.fillStyle=skin;ctx.fillRect(x-3,y+h*.57,8,7);ctx.fillRect(x+w-5,y+h*.57,8,7);
  ctx.fillStyle=skin;ctx.fillRect(x+5,y+5,w-10,h*.3);
  ctx.fillStyle=navy;ctx.fillRect(x+4,y,w-8,10);
  ctx.fillStyle='#ccd';ctx.fillRect(x+4,y+8,w-8,3);
  ctx.fillStyle='#111';
  if(dir>0)ctx.fillRect(x+w-4,y+6,10,4);else ctx.fillRect(x-6,y+6,10,4);
  ctx.fillStyle='#f1c40f';ctx.beginPath();ctx.ellipse(x+w/2,y+4,5,3.5,0,0,Math.PI*2);ctx.fill();
  ctx.fillStyle='#2c3e50';
  const eox=dir>0?3:-2;
  ctx.fillRect(x+8+eox,y+10,4,4);ctx.fillRect(x+w-12+eox,y+10,4,4);
}
